...
export interface SelectProps extends Omit<ReactSelectProps<Option, false>, "options" | "value" | "onChange"> {
  options: Option[];
  value: Option | null;
...
const Select: React.FC<SelectProps> = ({ options, value, onChange, isDisabled, className }) => {
